const theme: ThemeConfig = {
  dark: {
    ...
    '--heroui-danger-50': '220 80% 10.39%',
    '--heroui-danger-100': '220 80% 20.39%',
    '--heroui-danger-200': '220 80% 30.78%',
    '--heroui-danger-300': '220 80% 40.78%',
    '--heroui-danger-400': '220 80% 51.18%',
    '--heroui-danger-500': '220 80% 60.78%',
    '--heroui-danger-600': '220 80% 70.78%',
    '--heroui-danger-700': '220 80% 80.39%',
    '--heroui-danger-800': '220 80% 90.39%',
    '--heroui-danger-900': '220 80% 95.1%',
    '--heroui-danger-foreground': '0 0% 100%',
    '--heroui-danger': '220 80% 60%',
    '--heroui-primary-50': '217 91.2% 10.39%',
    '--heroui-primary-100': '217 91.2% 20.39%',
    '--heroui-primary-200': '217 91.2% 30.78%',
    '--heroui-primary-300': '217 91.2% 40.78%',
    '--heroui-primary-400': '217 91.2% 51.18%',
    '--heroui-primary-500': '217.2 91.2% 59.8%',
    '--heroui-primary-600': '217 91.2% 70.78%',
    '--heroui-primary-700': '217 91.2% 80.39%',
    '--heroui-primary-800': '217 91.2% 90.39%',
    '--heroui-primary-900': '217 91.2% 95.1%',
    ...
    '--heroui-strong': '200 94.67% 44.12%',
    '--heroui-code-mdx': '200 94.67% 44.12%',
  ...
  light: {
    ...
    '--heroui-danger-50': '220 80% 95.1%',
    '--heroui-danger-100': '220 80% 90.39%',
    '--heroui-danger-200': '220 80% 80.39%',
    '--heroui-danger-300': '220 80% 70.78%',
    '--heroui-danger-400': '220 80% 60.78%',
    '--heroui-danger-500': '220 80% 51.18%',
    '--heroui-danger-600': '220 80% 40.78%',
    '--heroui-danger-700': '220 80% 30.78%',
    '--heroui-danger-800': '220 80% 20.39%',
    '--heroui-danger-900': '220 80% 10.39%',
    '--heroui-danger-foreground': '0 0% 100%',
    '--heroui-danger': '220 80% 60%',
    '--heroui-primary-50': '217 91.2% 95.1%',
    '--heroui-primary-100': '217 91.2% 90.39%',
    '--heroui-primary-200': '217 91.2% 80.39%',
    '--heroui-primary-300': '217 91.2% 70.78%',
    '--heroui-primary-400': '217 91.2% 60.78%',
    '--heroui-primary-500': '217.2 91.2% 59.8%',
    '--heroui-primary-600': '217 91.2% 40.78%',
    '--heroui-primary-700': '217 91.2% 30.78%',
    '--heroui-primary-800': '217 91.2% 20.39%',
    '--heroui-primary-900': '217 91.2% 10.39%',
    '--heroui-primary-foreground': '0 0% 100%',
    '--heroui-primary': '217.2 91.2% 59.8%',
    ...
    '--heroui-strong': '200 100% 65.29%',
    '--heroui-code-mdx': '200 100% 65.29%',
    '--heroui-divider-weight': '1px',
    '--heroui-disabled-opacity': '.5',
    '--heroui-font-size-tiny': '0.75rem',
    '--heroui-font-size-small': '0.875rem',
...
export default {
  ...
  author: 'MorningCat',
  name: 'nc_pink',
  description: 'MorningCat Blue Theme',
} satisfies ThemeInfo;
